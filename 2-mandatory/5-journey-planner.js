...
*/
function getTransportModes(locationArr) {
  return locationArr.slice(1, locationArr.length);
}
...
*/
function isAccessibleByTransportMode(transportArr, transMode) {
  if (transportArr.includes(transMode)) return true;
  else return false;
}
...
*/
function journeyPlanner(locationsArr, transportMode) {
